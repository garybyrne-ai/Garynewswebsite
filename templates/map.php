...
<section class="container pagehead">
  ...
  <h1 class="pagehead__title"><span class="pagehead__icon" aria-hidden="true">◎</span>Ireland, <em>right now.</em></h1>
...
<div class="container mappage" data-map-root>
  <div>
    <div class="mapchips">
      ...
      <button type="button" class="btn btn--ghost btn--sm" data-locate style="margin-left:auto">◎ Use my location</button>
    </div>
    ...
    <div class="maplegend">
      ...
      <span>◌ newest stories pulse</span>
    </div>
  </div>
  <aside>
